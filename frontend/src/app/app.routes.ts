...
import { DashboardHistoricoComponent } from "./routes/dashboard-historico/dashboard-historico/dashboard-historico.component";
//import "./routes/dashboard-historico/dashboard-historico/dashboard-historico.component";
